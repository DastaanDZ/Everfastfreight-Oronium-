        ...
        <div className={styles.info}>
          <div className={styles.left}>
            ...
            <p className={styles.desc}>
              At Everfast, we aim to make work easier for everyone — both for
              our own employees and for businesses all around the world. By
              working at Everfast, you get to be part of a team that makes work
              better for everyone.The hiring team reviews applications based on
              a job-specific rubric. Our interview process varies by role; your
              recruiter will share what the rest of the interview process will
              entail on your first video call.
            </p>
